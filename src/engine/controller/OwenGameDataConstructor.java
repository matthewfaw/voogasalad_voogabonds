...
public class OwenGameDataConstructor {
...
//			terrainMap.getDestination();
	...
	{
		JSONSerializer ser = new JSONSerializer();
		OwenGameDataConstructor m = new OwenGameDataConstructor();
		m.constructMockData();
	}
}
